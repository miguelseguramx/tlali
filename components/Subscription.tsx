...
export default function Subscription({}: Props) {
  return (
    ...
    <div className="relative">
      <div
        className="overflow-hidden relative w-full h-96 bg-[#05668d] opacity-70 md:rounded-b-2xl md:rounded-tr-2xl md:rounded-tl-[6rem]">
        {/*  right pattern  */}
      ...
      <div className="absolute top-0 flex items-center w-full h-full">
        <div className="flex flex-col items-center max-w-2xl mx-auto my-16">
          <h1 className="max-w-sm text-xl leading-normal text-center text-white md:max-w-full md:text-2xl font-poppins">
            Suscribete para recibir informacion y ofertas exclusivas
          </h1>
          <div className="flex flex-col w-full gap-5 mt-10 md:flex-row md:mt-20">
            ...
            <button
              className="inline-block bg-[#02c39a] hover:bg-[#28bc9c] font-poppins px-7 py-2 rounded-lg text-white text-lg">
              Subscribe
            </button>
          </div>
        </div>
