  ...
  return (
    <section className="w-8/12 pb-10 mx-auto mt-32 mb-16">
      <div className="max-w-lg text-center text-gray-800 md:text-start font-poppins">
        <p className="text-gray-600">Facil y Rapido</p>
        <h2 className="my-4 text-4xl text-gray-800 md:text-5xl font-poppins">
          Agenda tu viaje en 3 simples pasos
        </h2>
      </div>
      ...
      <div className="relative flex flex-col gap-20 my-20 md:flex-row md:gap-10 md:justify-between">
        <div className="flex flex-col gap-12">
          <div className="flex items-center w-full">
            <div className="grid p-3 rounded-xl w-16 h-[3.2rem] bg-[#02c39a] place-items-center">
              <img
            ...
            <div className="flex flex-col mx-4 text-[#5E6282] break-words font-poppins w-max">
              <h3 className="font-sans text-2xl">Escoge tu destino</h3>
            </div>
          </div>
          <div className="flex items-center w-full">
            <div className="grid p-3 rounded-xl w-16 h-[3.2rem] bg-[#00a896] place-items-center">
              <svg
            ...
            <div className="flex flex-col mx-4 text-[#5E6282] break-words font-sans text-2xl w-max">
              <h5>Paga</h5>
            </div>
          </div>
          <div className="flex items-center w-full">
            <div className="grid p-3 rounded-xl w-16 h-[3.2rem] bg-[#05668d] place-items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22.5"
                height="18.75"
        ...
        >
          <div className="flex flex-col mt-4 font-poppins">
            <img
              src="./images/iztla.jpeg"
              width={360}
              className="z-10 object-cover"
              alt="Image of a girl in greece"
            />
            <p className="mt-4 text-lg">Viaje a la mujer dormida</p>
            <div className="flex text-[#64636e] font-poppins text-base my-2">
              <p className="mx-1">14-29 Junio</p>
              <p className="mx-2">|</p>
              <p>Robbin Joseph</p>
            </div>
            ...
            <div className="flex justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[#64636e]">24 personas estan en tu grupo</p>
              </div>
